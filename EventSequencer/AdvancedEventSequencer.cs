...
public class AdvancedEventSequencer : MonoBehaviour
{
    [SerializeField] AdvancedEventStep[] steps;
    ...
    IEnumerator RunSequence()
    {
        ...
        do
        {
            ...
            {
                AdvancedEventStep step = steps[currentIndex];
...
[Serializable]
public class AdvancedEventStep
{
    public string id;
